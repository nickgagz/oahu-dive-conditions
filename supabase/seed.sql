-- ═══════════════════════════════════════════════════════════════════════════
-- Oahu Dive Conditions — Complete Seed Data
-- Run this AFTER migration.sql to populate with initial data.
-- Safe to re-run: all INSERTs use ON CONFLICT DO NOTHING.
--
-- Contents: 8 dive sites, 156 forecast snapshots, 156 dive reports
-- ═══════════════════════════════════════════════════════════════════════════
...
INSERT INTO dive_sites (id, name, region, exposure_notes) VALUES
  ('electric-beach', 'Electric Beach (Kahe)', 'West Oahu',
...
INSERT INTO forecast_snapshots (id, datetime, swell_height, swell_direction, swell_period, wind_speed, wind_direction, wind_category, tide_state) VALUES
  ...
  -- ─── ELECTRIC BEACH — original set ──────────────────────────────────────
  -- Small summer conditions
  ('fc-001', '2025-06-15T08:00:00-10:00', 1.5, 'S',  14, 8,  80,  'offshore', 'incoming'),
  ('fc-002', '2025-06-22T07:00:00-10:00', 2.0, 'S',  12, 6,  90,  'offshore', 'low'),
  ('fc-003', '2025-07-04T09:00:00-10:00', 1.0, 'SW', 16, 5,  70,  'offshore', 'high'),
  ('fc-004', '2025-07-12T08:00:00-10:00', 1.5, 'SW', 13, 10, 100, 'offshore', 'outgoing'),
  ('fc-005', '2025-07-20T06:00:00-10:00', 1.0, 'S',  15, 4,  85,  'offshore', 'incoming'),
  ('fc-006', '2025-08-02T08:00:00-10:00', 2.0, 'S',  11, 7,  75,  'offshore', 'low'),
  ('fc-007', '2025-08-10T09:00:00-10:00', 1.5, 'SW', 14, 6,  90,  'offshore', 'high'),
  -- Moderate conditions
  ('fc-008', '2025-09-05T08:00:00-10:00', 3.0, 'S',  10, 12, 240, 'onshore', 'incoming'),
  ('fc-009', '2025-09-15T07:00:00-10:00', 3.5, 'SW', 11, 14, 260, 'onshore', 'outgoing'),
  ('fc-010', '2025-10-01T08:00:00-10:00', 3.0, 'W',  12, 10, 250, 'onshore', 'high'),
  ('fc-011', '2025-10-10T09:00:00-10:00', 2.5, 'SW', 13, 8,  180, 'cross',   'low'),
  ('fc-012', '2025-10-20T08:00:00-10:00', 3.0, 'W',  10, 15, 270, 'onshore', 'incoming'),
  ('fc-013', '2025-11-01T07:00:00-10:00', 2.5, 'S',  12, 9,  160, 'cross',   'outgoing'),
  -- Larger winter swells
  ('fc-014', '2025-11-15T08:00:00-10:00', 4.0, 'NW', 14, 18, 300, 'onshore', 'high'),
  ('fc-015', '2025-12-01T08:00:00-10:00', 5.0, 'NW', 16, 20, 310, 'onshore', 'incoming'),
  ('fc-016', '2025-12-10T09:00:00-10:00', 4.5, 'W',  15, 16, 280, 'onshore', 'outgoing'),
  ('fc-017', '2026-01-05T08:00:00-10:00', 5.5, 'NW', 17, 22, 290, 'onshore', 'low'),
  ('fc-018', '2026-01-15T07:00:00-10:00', 3.5, 'W',  13, 12, 260, 'onshore', 'high'),
  ('fc-019', '2026-02-01T08:00:00-10:00', 4.0, 'W',  14, 14, 270, 'onshore', 'incoming'),
  -- Calm conditions
  ('fc-020', '2025-06-08T06:00:00-10:00', 0.5, 'S',  18, 3,  90,  'offshore', 'low'),
  ('fc-021', '2025-07-01T07:00:00-10:00', 0.8, 'SW', 16, 4,  80,  'offshore', 'incoming'),
  ('fc-022', '2025-07-28T06:00:00-10:00', 0.5, 'S',  20, 2,  95,  'offshore', 'high'),
  ('fc-023', '2025-08-15T08:00:00-10:00', 1.0, 'S',  17, 5,  85,  'offshore', 'low'),
  ('fc-024', '2025-08-25T07:00:00-10:00', 0.8, 'SW', 15, 3,  90,  'offshore', 'outgoing'),

  -- ─── ELECTRIC BEACH — extra cross-wind ──────────────────────────────────
...
INSERT INTO dive_reports (id, site_id, datetime, visibility_category, surge_category, entry_exit_category, current_category, surface_conditions, notes, forecast_snapshot_id) VALUES
  ...
  -- Small summer / calm
  ('rpt-001', 'electric-beach', '2025-06-15T08:30:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'mild',     'flat',       'Crystal clear morning. Spotted dolphins near the outflow. Very little current.', 'fc-001'),
  ('rpt-002', 'electric-beach', '2025-06-22T07:30:00-10:00', 'good (40-80 ft)',    'light',    'easy',        'none',     'flat',       'Easy entry. Turtles resting on the bottom at the warm water pipe.', 'fc-002'),
  ('rpt-003', 'electric-beach', '2025-07-04T09:30:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'none',     'flat',       'Holiday dive, still uncrowded early. Vis was outstanding.', 'fc-003'),
  ('rpt-004', 'electric-beach', '2025-07-12T08:15:00-10:00', 'good (40-80 ft)',    'light',    'easy',        'mild',     'light chop', 'Slight wind chop on surface but fine underwater. Good vis at depth.', 'fc-004'),
  ('rpt-005', 'electric-beach', '2025-07-20T06:30:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'none',     'flat',       'Dawn patrol. Glass calm. Manta ray spotted!', 'fc-005'),
  ('rpt-006', 'electric-beach', '2025-08-02T08:20:00-10:00', 'good (40-80 ft)',    'light',    'easy',        'mild',     'flat',       'Typical summer conditions. Warm water, good vis.', 'fc-006'),
  ('rpt-007', 'electric-beach', '2025-08-10T09:15:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'none',     'flat',       'Perfect morning. Lots of fish near the pipe.', 'fc-007'),
  -- Ultra-calm
  ('rpt-008', 'electric-beach', '2025-06-08T06:30:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'none',     'flat',       'Lake-flat conditions. Could see the bottom from shore. Best dive of the year so far.', 'fc-020'),
  ('rpt-009', 'electric-beach', '2025-07-01T07:20:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'none',     'flat',       'Incredible vis. Spinner dolphins came through the area.', 'fc-021'),
  ('rpt-010', 'electric-beach', '2025-07-28T06:45:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'none',     'flat',       'Glass-off morning. Vis easily 100+. No current whatsoever.', 'fc-022'),
  ('rpt-011', 'electric-beach', '2025-08-15T08:10:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'mild',     'flat',       'Very calm. Slight drift near the outflow pipe as always.', 'fc-023'),
  ('rpt-012', 'electric-beach', '2025-08-25T07:30:00-10:00', 'excellent (80+ ft)', 'none',     'easy',        'none',     'flat',       'Early morning dive. Zero surge, zero current. Turtles everywhere.', 'fc-024'),
  -- Moderate
  ('rpt-013', 'electric-beach', '2025-09-05T08:30:00-10:00', 'moderate (20-40 ft)', 'moderate', 'manageable', 'moderate', 'light chop', 'South swell picking up. Entry was fine but surge noticeable at the shelf. Still diveable.', 'fc-008'),
  ('rpt-014', 'electric-beach', '2025-09-15T07:45:00-10:00', 'moderate (20-40 ft)', 'moderate', 'manageable', 'moderate', 'rough',      'SW swell coming in. Surface was choppy. Vis dropped to about 25 ft. Strong pull near the rocks.', 'fc-009'),
  ('rpt-015', 'electric-beach', '2025-10-01T08:20:00-10:00', 'moderate (20-40 ft)', 'moderate', 'manageable', 'moderate', 'light chop', 'West swell. Surge was consistent but manageable. Vis around 30 ft.', 'fc-010'),
  ('rpt-016', 'electric-beach', '2025-10-10T09:10:00-10:00', 'good (40-80 ft)',    'light',    'easy',        'mild',     'light chop', 'Cross-shore wind made surface choppy but underwater was decent. Vis around 50 ft.', 'fc-011'),
  ('rpt-017', 'electric-beach', '2025-10-20T08:30:00-10:00', 'poor (< 20 ft)',     'heavy',    'challenging', 'strong',   'rough',      'Onshore wind + west swell = tough conditions. Entry was difficult over the rocks. Poor vis.', 'fc-012'),
  ('rpt-018', 'electric-beach', '2025-11-01T07:30:00-10:00', 'good (40-80 ft)',    'light',    'manageable',  'mild',     'light chop', 'Conditions were better than expected. Cross wind kept surface bumpy but good vis below.', 'fc-013'),
  -- Winter
  ('rpt-019', 'electric-beach', '2025-11-15T08:30:00-10:00', 'poor (< 20 ft)',     'heavy',    'challenging', 'strong',   'rough',      'NW swell hitting hard. Would not recommend for newer divers. Vis was about 10 ft. Strong surge.', 'fc-014'),
  ('rpt-020', 'electric-beach', '2025-12-01T08:45:00-10:00', 'poor (< 20 ft)',     'heavy',    'challenging', 'strong',   'rough',      'Big NW swell. Entry was sketchy. Underwater was a washing machine. Aborted after 10 min.', 'fc-015'),
  ('rpt-021', 'electric-beach', '2025-12-10T09:20:00-10:00', 'moderate (20-40 ft)', 'heavy',   'challenging', 'strong',   'rough',      'Big west swell wrapping in. Surge was heavy but vis wasn''t terrible once past the entry.', 'fc-016'),
  ('rpt-022', 'electric-beach', '2026-01-05T08:30:00-10:00', 'poor (< 20 ft)',     'heavy',    'challenging', 'strong',   'rough',      'Huge NW swell. Not a diving day. Went to look and turned around.', 'fc-017'),
  ('rpt-023', 'electric-beach', '2026-01-15T07:30:00-10:00', 'moderate (20-40 ft)', 'moderate', 'manageable', 'moderate', 'light chop', 'Smaller west swell day in winter. Manageable conditions. Vis about 30 ft.', 'fc-018'),
  ('rpt-024', 'electric-beach', '2026-02-01T08:20:00-10:00', 'moderate (20-40 ft)', 'moderate', 'manageable', 'moderate', 'light chop', 'West swell still running. Entry doable but needs timing. Decent vis at depth.', 'fc-019'),
  -- Extra cross-wind
